@if (! empty($document))
    @php
        ...
        $tax_rate_description = trans('documents.tax_rate.changed_description')
            ...
            . '<input type="checkbox" v-model="recalculate_taxes" class="rounded-sm text-purple border-gray-300 cursor-pointer focus:outline-none focus:ring-transparent ltr:mr-2 rtl:ml-2">'
